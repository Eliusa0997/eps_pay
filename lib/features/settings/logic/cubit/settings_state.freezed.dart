...
class Loading<T> implements SettingsState<T> {
  const Loading();
...
class Success<T> implements SettingsState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SettingsStateCopyWith<T, $Res> {
...
class Error<T> implements SettingsState<T> {
...
@override
String toString() {
  return 'SettingsState<$T>.error(apiErrorModel: $apiErrorModel)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $SettingsStateCopyWith<T, $Res> {
